                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($order->order_status == 1 || $order->order_status == 2)
                                            <td><span class="label label-default">{{ \App\Helper\Helper::orderStatus($order->order_status) }}</span></td>
                                        @elseif($order->order_status == 3 || $order->order_status == 6)
                                            <td><span class="label label-success">{{ \App\Helper\Helper::orderStatus($order->order_status) }}</span></td>
                                        @elseif($order->order_status == 4 || $order->order_status == 5 || $order->order_status == 7)
                                            <td><span class="label label-info">{{ \App\Helper\Helper::orderStatus($order->order_status) }}</span></td>
                                        @elseif($order->order_status == 8)
                                            <td><span class="label label-danger">{{ \App\Helper\Helper::orderStatus($order->order_status) }}</span></td>
                                        @endif
