...
<table width="540" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:38px 30px 30px 30px;background-color:#fafafa">
		...
		<td>
			<table>
				...
				<tr>
					...
					<td>
					<div align="center">
						<a style="text-decoration:none" width="200px" href="{{ \Cloudder::secureShow($orderProduct->product->image) }}" target="_blank">
						<img border="0" src="{{ \Cloudder::secureShow($orderProduct->product->image) }}" style="width:80px;min-height:auto" class="CToWUd">
						</a><br>
	...
	<tr>
		<td>
			...
			<tbody>
				<tr>
					<td><div style="padding-left:300px;padding-right:10px;font-size:15px;margin-top:10px;font-family:Arial,Helvetica,sans-serif;color:green">Delivery Charge(+)</div></td><td> Rs. {{ $order->shipping_charge }}</td>
				</tr>
	...
	<tr><td align="center" style="font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#929292"><div style="padding-bottom:10px">All Rights Reserved. Online DAM Packs</div>
	<p style="padding:10px 0 0 0;margin:0;border-top:solid 1px #cccccc;font-size:11px;color:#565656">24x7 Customer Support&nbsp; | &nbsp;Policy&nbsp; | &nbsp;Flexible Payment Options&nbsp; | &nbsp;many Categories</p>
	</td>
	</tr>
	</tbody>
</table>
