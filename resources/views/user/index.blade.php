    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col col-sm-5">
                            ...
                            <div class="get-quote">
                                <a href="javascript:void(0);" class="theme-btn">Request Quote</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- end container -->
            ...
            <nav class="navigation navbar navbar-default">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <div class="site-logo">
                            <a href="javascript:void(0);"><img src="/front/images/logo-2.png" alt></a>
                        </div>
                    </div>
        ...
        <section class="hero hero-slider-wrapper hero-slider-style-2">
            <div class="hero-slider">
                <div class="slide">
                    <img src="/front/images/slider/slide-3.jpg" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col col-md-8 col-md-offset-2 slide-caption">
                                ...
                                <div class="btns">
                                    ...
                                    <a href="javascript:void(0);" class="theme-btn-s2">Explore</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slide">
                    <img src="/front/images/slider/slide-1.jpg" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col col-md-8 col-md-offset-2 slide-caption">
                                <h2>We provide the best <span>Industrial</span> Services worldwide</h2>
                                <p>An unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                <div class="btns">
                                    <a href="javascript:void(0);" class="theme-btn">About us</a>
                                    <a href="javascript:void(0);" class="theme-btn-s2">Explore</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col col-xs-12">
                        <div class="row service-s2-top">
                            <div class="col col-xs-12 service-s2-tab">
                                ...
                                <ul class="tablinks">
                                    <li class="active">
                                        <a href="#tab-1" data-toggle="tab">01 <span>Metal Grinding</span></a>
                                    </li>
                                    <li>
                                        <a href="#tab-2" data-toggle="tab">02 <span>Metal Grinding</span></a>
                                    </li>
                                    <li>
                                        <a href="#tab-3" data-toggle="tab">03<span>Metal Grinding</span></a>
                                    </li>
                                    <li>
                                        <a href="#tab-4" data-toggle="tab">04<span>Metal Grinding</span></a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane in active" id="tab-1">
                                        <div class="img-holder">
                                            <img src="/front/images/services/img-4.jpg" alt>
                                        </div>
                                        <div class="details">
                                            <h3>Metal Grinding</h3>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            <a href="javascript:void(0);" class="more">View Details <i class="fa fa-angle-right"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="row service-s2-box">
                            <div class="col col-xs-12">
                                <div class="service-s2-box-grids">
                                    <div class="grid">
                                        <div class="inner">
                                            <h3><span class="num">01</span> Design</h3>
                                            <p>Sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                        </div>
                                    </div>
                                    <div class="grid">
                                        <div class="inner">
                                            <h3><span class="num">02</span> Plan</h3>
                                            <p>Sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                        </div>
                                    </div>
                                    <div class="grid">
                                        <div class="inner">
                                            <h3><span class="num">03</span> Develop</h3>
                                            <p>Sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="recent-projects-grids">
                        <div class="grid">
                            <div class="project-img">
                                <img src="/front/images/projects/img-1.jpg" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="javascript:void(0);"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="/front/images/projects/img-2.jpg" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="javascript:void(0);"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="/front/images/projects/img-3.jpg" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="javascript:void(0);"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="/front/images/projects/img-4.jpg" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="javascript:void(0);"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="/front/images/projects/img-5.jpg" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="javascript:void(0);"><h3>Chemical Refinery</h3></a>
        ...
        <!-- start cta-newsletter -->
        <section class="cta-newsletter parallax" data-bg-image="/front/images/contact-section-bg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="cta-newsletter-inner">
                            <h3>Signup for our <span>newsletter</span> &amp; promotions</h3>
                        ...
                        <div class="newsletter-pic">
                            <img src="/front/images/newsletter-pic.png" alt>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-padding">
            <div class="container">
                ...
                <div class="row">
                    <div class="col col-lg-10 col-lg-offset-1">
                        <div class="testimoials-s2-grids testimoials-s2-slider">
                            <div class="testimoials-s2-grid">
                                ...
                                <div class="client-info">
                                    <div class="details">
                                        <div class="pic">
                                            <img src="/front/images/testimonials/img-1.jpg" alt>
                                        </div>
                                        <div class="info">
                                            <h4>Anne Frank</h4>
                                            <p>CEO, Gryffindor</p>
                            ...
                            <div class="testimoials-s2-grid">
                                ...
                                <div class="client-info">
                                    <div class="details">
                                        <div class="pic">
                                            <img src="/front/images/testimonials/img-2.jpg" alt>
                                        </div>
                                        <div class="info">
                                            <h4>Anne Frank</h4>
                                            <p>CEO, Gryffindor</p>
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-3 col-md-3">
                       <div class="all-news-link">
                            <a href="javascript:void(0);" class="theme-btn">More News</a>
                       </div>
                    </div>
                </div> <!-- end row -->
                        ...
                        <div class="news-grids">
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="/front/images/blog/img-1.jpg" alt>
                                </div>
                                <div class="entry-details">
                                    <div class="entry-meta">
                                        <ul>
                                            <li><i class="fa fa-clock-o"></i>Nov 25</li>
                                            <li><i class="fa fa-comments"></i><a href="javascript:void(0);">2 Comments</a></li>
                                        </ul>
                                    </div>
                                    <div class="entry-body">
                                        <h3><a href="javascript:void(0);">China's industrial profits grow faster in first eight months</a></h3>
                            ...
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="/front/images/blog/img-2.jpg" alt>
                                </div>
                                <div class="entry-details">
                                    <div class="entry-meta">
                                        <ul>
                                    ...
                                    <div class="entry-body">
                                        <h3><a href="javascript:void(0);">Exploring the wild side in an industrial jungle</a></h3>
                                        <p>Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="/front/images/blog/img-3.jpg" alt>
                                </div>
                                <div class="entry-details">
                                    <div class="entry-meta">
                                        <ul>
                                    ...
                                    <div class="entry-body">
                                        <h3><a href="javascript:void(0);">Bus drivers in Liverpool vote for industrial action</a></h3>
                                        <p>Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                    </div>
                                </div>
                            </div>
