...
<html lang="en">
<head>
	<title>Waiting...for Payment | DAM Packs</title>
...
<body>
	...
	<div class="container" style="padding:40px;" align="center">
		<div class="row">
			<div class="jumbotron">
				<img src="/front/images/logo.png" alt="DAM Packs" class="img-responsive" style="width: 20%;"><p><br></p>
				<h2>We are going to our Payment Services...</h2>
				<p>Wait for Few Seconds...</p>
				<span style="font-size:30px;color:#2377ad;"><i class="fa fa-spinner fa-spin fa-5x"></i></span>
			</div>
			<div style="margin-top:40px;"> All Rights Reserved @ DAM Packs</div>
		</div>
	</div>
	<!-- Core JS files -->
